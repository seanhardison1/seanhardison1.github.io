---
title: Lower trophic level processing & visualization
author: ~
date: '2018-11-21'
slug: lower-trophic-level-processing-visualization
categories: []
tags: []
draft: yes
---
...
#Data directories
raw.dir <- "~/git/soe/inst/extdata" #raw data directory
clean.dir <- "~/git/soe/data" #output directory for cleaned data
gis.dir <- "~/git/soe/inst/extdata/gis"
sample.dir <- "~/git/soe/inst/extdata/sample"
...
epu_env <- function(variable, type = NULL, season, genus = NULL, epu){
  ...
  indir <- "~/git/soe/inst/extdata/gridded"
